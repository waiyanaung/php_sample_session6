...
if (isset($_GET['id']) && $_GET['id'] != "") {
    ...
    //updating the table
    $query = "UPDATE products SET status='0', updated_at='$update_at', updated_by = '$login_id' WHERE id='$id'";

    $result = mysqli_query($mysqli, $query);

    $messages = "<p><font color='blue'>Success - Deleting Data !</font></p>";
    $messages .= "<p><font color='blue'>Product deleted successfully !.</font></p>";
    $_SESSION['messages'] = $messages;
    header("Location: product_list.php");
} else {

    $errors = "<p><font color='red'>Errors in Deleting Data !</font></p>";
    $errors .= "<p><font color='red'>Error while deleting product !.</font></p>";
